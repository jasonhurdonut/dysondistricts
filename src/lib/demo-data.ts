...
export const DEMO_HOUSES: House[] = [
  { id: 1, name: "Triphammer", slug: "triphammer", color: "#8B5CA5", crest_url: "/crests/triphammer.png", groupme_url: "https://groupme.com/join_group/demo-triphammer", leaders: null, tagline: "Bold leaders who build momentum and inspire action.", description: "Named for Triphammer Falls, Triphammer is the district of drive. Expect them first in line at every challenge drop and loudest at the leaderboard reveal." },
  { id: 2, name: "Lucifer", slug: "lucifer", color: "#BE4B44", crest_url: "/crests/lucifer.png", groupme_url: "https://groupme.com/join_group/demo-lucifer", leaders: null, tagline: "Passionate and fearless, lighting the way for others.", description: "Named for Lucifer Falls at Treman, Lucifer burns bright. A district that turns up in force, competes with heart, and never leaves a teammate behind." },
  { id: 3, name: "Rocky", slug: "rocky", color: "#8E8E8E", crest_url: "/crests/rocky.png", groupme_url: "https://groupme.com/join_group/demo-rocky", leaders: null, tagline: "Steady and resilient, standing strong through every challenge.", description: "Named for Rocky Falls, Rocky is the bedrock district — consistent, dependable, and impossible to rattle when the semester gets loud." },
  { id: 4, name: "Cascadilla", slug: "cascadilla", color: "#2E8F3E", crest_url: "/crests/cascadilla.png", groupme_url: "https://groupme.com/join_group/demo-cascadilla", leaders: null, tagline: "Grounded and growing, cultivating community and balance.", description: "Named for Cascadilla Gorge, Cascadilla grows on connection. The district most likely to bring a friend, start a tradition, and make Dyson feel small in the best way." },
  { id: 5, name: "Taughannock", slug: "taughannock", color: "#5E7FC4", crest_url: "/crests/taughannock.png", groupme_url: "https://groupme.com/join_group/demo-taughannock", leaders: null, tagline: "Adaptable and thoughtful, flowing with purpose and creativity.", description: "Named for Taughannock Falls — taller than Niagara — Taughannock takes the creative line through every problem and makes it look easy." },
  { id: 6, name: "Buttermilk", slug: "buttermilk", color: "#DFA733", crest_url: "/crests/buttermilk.png", groupme_url: "https://groupme.com/join_group/demo-buttermilk", leaders: null, tagline: "Reliable and uplifting, nourishing success together.", description: "Named for Buttermilk Falls, Buttermilk is the district that feeds the whole program — steady points, warm welcomes, and the best team spirit in Dyson." },
];
